    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="p-6 border-2 rounded-2xl bg-white dark:bg-slate-950/20 border-slate-200 dark:border-slate-800/80 shadow-[0_0_20px_rgba(0,0,0,0.01)] space-y-6">
            <h3 className="text-base font-bold font-outfit text-slate-800 dark:text-slate-200 border-b border-slate-200/60 dark:border-slate-800/80 pb-3">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-xs">
                <span className="font-extrabold text-slate-700 dark:text-slate-300">Step Execution Delay</span>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-xs">
                <span className="font-extrabold text-slate-700 dark:text-slate-300">DOM Stability Element Timeout</span>
                <span className="font-mono font-bold text-indigo-600 dark:text-indigo-400">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-xs">
                <span className="font-extrabold text-slate-700 dark:text-slate-300">Max Stability Step Retries</span>
                <span className="font-mono font-bold text-indigo-600 dark:text-indigo-400">
          ...
          <div className="p-6 border-2 rounded-2xl bg-white dark:bg-slate-950/20 border-slate-200 dark:border-slate-800/80 shadow-[0_0_20px_rgba(0,0,0,0.01)] space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
              <div className="space-y-0.5">
                <span className="text-xs font-extrabold text-slate-700 dark:text-slate-300 block">Capped Log Entries Buffer</span>
              ...
              <input
                ...
                className="w-full sm:w-36 px-4 py-2 border-2 rounded-xl bg-slate-50 dark:bg-slate-950 border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-200 text-xs font-bold font-mono focus:outline-none focus:border-indigo-500"
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
              <div className="space-y-0.5">
                <span className="text-xs font-extrabold text-slate-700 dark:text-slate-300 block">Retention Period</span>
                <span className="text-[10px] text-slate-400 dark:text-slate-500 block leading-normal">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          {/* Theme Settings Card */}
          <div className="p-6 border-2 rounded-2xl bg-white dark:bg-slate-950/20 border-slate-200 dark:border-slate-800/80 shadow-[0_0_20px_rgba(0,0,0,0.01)] space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`py-3 px-4 border-2 rounded-xl flex items-center justify-center gap-2 font-bold text-xs active:scale-95 transition-all duration-200 ${
                  currentTheme === 'light'
          ...
          <div className="p-6 border-2 rounded-2xl bg-white dark:bg-slate-950/20 border-slate-200 dark:border-slate-800/80 shadow-[0_0_20px_rgba(0,0,0,0.01)] space-y-4">
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-rose-500/10 hover:bg-rose-500 text-rose-500 hover:text-white border border-rose-500/20 hover:border-transparent font-bold text-xs transition active:scale-95 flex items-center justify-center gap-2"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {showWipeModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="w-full max-w-md border-2 border-rose-500/30 rounded-3xl bg-white dark:bg-slate-950 p-6 space-y-6 shadow-2xl animate-fade-in text-slate-950 dark:text-slate-100">
            <div className="space-y-2">
              <h4 className="text-base font-black font-outfit text-rose-600 dark:text-rose-500 flex items-center gap-2">
                ⚠️ Critical Database Wipe Action
              </h4>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-3 text-xs border-2 rounded-xl bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-800 font-bold font-mono text-center tracking-widest focus:outline-none focus:border-rose-500 uppercase text-slate-800 dark:text-slate-200"
              />
            </div>

            {wipeStatus && (
              <div className="text-xs text-center font-bold text-slate-600 dark:text-indigo-400 font-mono">
                {wipeStatus}
              </div>
            )}
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-3 bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 font-bold text-xs rounded-xl hover:bg-slate-200 active:scale-95 transition"
              >
                Cancel
              </button>
              <button
                ...
                className="flex-1 py-3 bg-rose-600 hover:bg-rose-500 disabled:opacity-40 text-white font-bold text-xs rounded-xl shadow-lg shadow-rose-600/10 active:scale-95 transition"
              >
                Authorize Wipe
              </button>
            </div>
