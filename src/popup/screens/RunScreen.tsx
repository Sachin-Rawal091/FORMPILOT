...
export const RunScreen: React.FC = () => {
  ...
  const isStarting = status === ExecutionStatus.STARTING;
        ...
        <div className="w-full max-w-4xl flex flex-col md:flex-row gap-4 items-center justify-between">
          ...
          <div className="flex gap-3 w-full md:w-auto shrink-0 justify-end">
            ...
            {isStarting && (
              <button
                disabled
                className="w-36 py-3 bg-indigo-500/50 text-indigo-200 font-semibold text-xs uppercase tracking-wider rounded-full flex items-center justify-center gap-2 cursor-not-allowed"
              >
